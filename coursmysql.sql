...
--
-- Host: localhost    Database: coursmysql
-- ------------------------------------------------------
...
CREATE TABLE `articles` (
  ...
  `article_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `users` (
  ...
  `gender` enum('M','F','X') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `users` VALUES (1,'James','Bond','M','2007-07-07','New-York',70),(2,'Jack','Bauer','M','2004-12-24','New-York',124),(3,'Lara','Croft','F','2000-08-01','Washington',58),(4,'Beyonce','Knowles','F','1981-09-04','Houston',52),(5,'Mario','Bros','X','1985-10-24','YoshiLand',111),(6,'Michelle','Obama','F','1962-12-15','Minesota',67),(7,'Konchita','La Bomba','X','1996-05-13','Suède',84),(8,'Cool','Blue','X','1984-11-09','Brussels',96),(9,'Romelu','Lukaku','M','1991-01-28','Anvers',105),(10,'Julien','Dunia','M','2001-09-11','New-York',70),(11,'Ismail','Lemarocain','M','1975-11-06','Brussels',88),(12,'Ceyhun','Lefeuxturk','X','2001-07-26','Brussels',81),(13,'Mickail','Amanask','X','1999-09-09','Anvers',99),(14,'Nisrin','Stagiaire','F','2009-10-10','Anvers',58);
...
-- Dump completed on 2025-11-27  5:58:03
