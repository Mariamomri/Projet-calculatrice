<!-- Une page Multiplication avec comme titre Multiplication qui aura un formulaire qui fera une
multiplication entre 2 nombres introduis au clavier et qui affichera la réponse. Attention on
ne pourra introduire que des numéros. Je veux que le résultat de la multiplication soit
sauvegardé. -->

<?php
    session_start();
    $title = "Multiplication";//titre de la page
    $nav = "multiplication";//indique la page active dans la nav      
    require "header.php";
...
<main class="main">
  ...
  <form action="/coursphp/mariamphpdecembre/multiplication.php" method="post">
    ...
    <div class="operations">
      ...
      <img src="assets/images/per.png" alt="Icona più" width="50px">
      ...
      <br>
      <br>
      <button type="submit" class="btn-form">multiplié</button>
    </div>
...
if ( $_SERVER["REQUEST_METHOD"] == "POST" ){
  ...
  $nombre2 = $_POST["nombre2"];
      ...
      $totale= multiplication($nombre1, $nombre2);

      
      //mostrare il risultato
      echo "<p class='calcul-result' > $nombre1 <img src='assets/images/per.png' alt='Icona più' width='50px' height='50px'> $nombre2  <img src='assets/images/egal.png' alt='Icona più' width='50px' height='50px'> $totale</p>";


       // b) sauvegarder la dernière multiplication
      $_SESSION['dernier*'] = "<p class='textop'>Votre dernière multiplication faite, est : $nombre1 multiplié par $nombre2 donne $totale</p>";
